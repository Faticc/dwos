...
-- цвета из LS_COLORS: di=каталоги, fi=файлы, ln=ссылки, *.ext=по расширению
...
local function display(names)
  ...
  elseif #names > 0 then
    -- колонки: наименьшее число строк, при котором всё влезает в ширину
