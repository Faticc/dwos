-- Устройства /dev: дерево компонентов и простые узлы (null, zero, random).
local comp = require("component")
local text = require("text")

local dcache, pcache = {}, {}
local adapters -- все переходники из /lib/core/devfs_adapters.lua
...
--- Переходник для типа компонента: сначала общий файл, потом отдельный
--- файл adapters/<тип>.lua (так их можно добавлять).
