...
-- Проверка "есть ли файл" без open: открытие файла стоит четверть бюджета
-- тика, а exists и isDirectory бесплатны.
...
--- Отложенная загрузка: редко нужная часть библиотеки лежит в отдельном
--- файле и читается при первом обращении к недостающему полю.
