...
-- Загруженные оболочки кешируются: состояние у оболочки хранить нельзя,
-- зато память не тратится на каждый запуск команды.
...
--- Свои копии псевдонимов и переменных у процесса (при первом обращении).
...
--- Путь относительно рабочего каталога; с ext - поиск программы по PATH.
...
--- Аргументы и ключи: -abc, --key, --key=value, -- конец ключей.
