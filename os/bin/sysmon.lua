-- sysmon: что происходит с машиной. Графики памяти и энергии рисуются
-- полублоками на пиксельном холсте gfx, подписи - обычным текстом поверх
-- готового кадра. Выход - q или Ctrl+C.
...
-- строки: заголовок, подпись графика, сам график, и так дважды
...
--- Столбики графика: доля 0..1 на каждый пиксельный столбец.
...
--- Сколько чего подключено и сколько места на дисках.
